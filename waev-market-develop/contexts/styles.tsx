...
// The Waev Dashboard main context
...
const MaterialUIControllerProvider = ({ children }: PropsWithChildren<Props>): JSX.Element => {
  // Waev Dashboard reducer

  function reducer(state: StateTypes, action: ActionTypes) {
    switch (action.type) {
      case 'MINI_SIDENAV': {
        return { ...state, isMiniSidenav: action.value };
      }
...
// Waev Dashboard custom hook for using context
